...
namespace WB.ConfigUpdate
{
    ...
    {
        public static void Run(string cmd, string workDirectory, DataReceivedEventHandler evt = null, List<string> environmentVars = null)
        {
            Process process = new();
            try
            {
                ...
                //注册到里面的外部事件处理
                process.OutputDataReceived += evt;
